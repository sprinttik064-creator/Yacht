...
- **Individual bottle renders (one per flavor, feed the per-flavor site blocks; portrait 3:4).** Template — swap {FLAVOR} / {CAP} / {ACCENT}: Pure → ivory cap, warm cream-white accent · Lime → green cap, green accent · Piña → golden yellow cap, golden accent · Ginger Yuzu → blue cap, cool blue accent:
  > Photorealistic product photograph in a dark upscale night club bar: a single 200 ml amber glass bottle standing on a black steel bar counter, aluminum screw cap in {CAP}, cream paper label reading "COCONUT MIXER / NIU / {FLAVOR} / 200 ml" with a small botanical line illustration. Camera at label height, label perfectly sharp; warm backlight glowing through the amber glass showing the liquid, fine condensation droplets. Behind the bottle a blurred mirrored disco ball and a deep red neon glow in the dark haze, plus a faint {ACCENT} light accent matching the cap color. Shallow depth of field, medium format look, moody speakeasy lighting, no people, no extra text. --ar 3:4
  - Consistency: generate all four in one session from this template, attach the v1 single-bottle photo as image/style reference (same bottle shape, same scene), change only cap/flavor/accent.
